                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                      <input type="text" class="form-control" id="find1" name="find1" value="<?php echo @$_REQUEST["find1"]?>" placeholder="幣商廣告名稱" />
                                      <?php if (@$_REQUEST["find1"]!=""){$find_msg.=($find_msg!="" ? "、" : "")."幣商廣告名稱=【".@$_REQUEST["find1"]."】";} ?>
                                    </div>
                                 </div>
                                <div class="form-group">
                                    <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">幣商帳號</label>
                                    <div class="col-xs-12 col-sm-5">
                                      <input type="text" class="form-control" id="find2" name="find2" value="<?php echo @$_REQUEST["find2"]?>" placeholder="幣商帳號" />
                                      <?php if (@$_REQUEST["find2"]!=""){$find_msg.=($find_msg!="" ? "、" : "")."幣商帳號=【".@$_REQUEST["find2"]."】";} ?>
                                    </div>
                                </div>
...
<table id="simple-table" class="table table-bordered table-hover table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo tb_sql("u_name","member",$row["mem_num"])?>【<?php echo tb_sql("u_id","member",$row["mem_num"])?>】</td>
            <td>
