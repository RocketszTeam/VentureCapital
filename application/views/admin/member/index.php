...
<?              }       ?>
                                ...
                                <div class="form-group">
                                    <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">推廣</label>
                                    <div class="col-xs-12 col-sm-5">
                                      <input type="text" class="form-control" id="find14" name="find14" value="<?php echo @$_REQUEST["find14"]?>" placeholder="推廣" />
                                      <?php if (@$_REQUEST["find14"]!=""){$find_msg.=($find_msg!="" ? "、" : "")."推廣=【".@$_REQUEST["find14"]."】";} ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                      <select class="form-control select2" name="find12" id="find12" data-placeholder="請選擇">
                                      	<option value="admin_num" <?php if (@$_REQUEST["find12"]=="admin_num"){?> selected="selected" <?php } ?>>代理</option>
                                        <option value="u_id" <?php if (@$_REQUEST["find12"]=="u_id"){?> selected="selected" <?php } ?>>帳號</option>                                          
										<option value="u_name" <?php if (@$_REQUEST["find12"]=="u_name"){?> selected="selected" <?php } ?>>姓名</option>                                     
                                        <option value="AllSave" <?php if (@$_REQUEST["find12"]=="AllSave"){?> selected="selected" <?php } ?>>儲值</option>                                 
                                        <option value="AllSell" <?php if (@$_REQUEST["find12"]=="AllSell"){?> selected="selected" <?php } ?>>拋售</option>                                
                                        <option value="WeekSell" <?php if (@$_REQUEST["find12"]=="WeekSell"){?> selected="selected" <?php } ?>>周拋售次數</option>
                                        <option value="reg_time" <?php if (@$_REQUEST["find12"]=="reg_time"){?> selected="selected" <?php } ?>>註冊時間</option>
                                        <option value="login_time" <?php if (@$_REQUEST["find12"] == "" || @$_REQUEST["find12"]=="login_time"){?> selected="selected" <?php } ?>>登入時間</option>
                                        <option value="login_ip" <?php if (@$_REQUEST["find12"]=="login_ip"){?> selected="selected" <?php } ?>>登入IP</option>
                                      </select>
                                      <select class="form-control select2" name="find13" id="find13" data-placeholder="請選擇">
                                      	<option value="desc" <?php if (@$_REQUEST["find13"] == "" || @$_REQUEST["find13"]=="desc"){?> selected="selected" <?php } ?>>▼</option>
                                        <option value="asc" <?php if (@$_REQUEST["find13"]=="asc"){?> selected="selected" <?php } ?>>▲</option>
									  ...
									  if (@$_REQUEST["find12"]!=""){
											...
											$find_msg.="排序=【".@$sortA[$_REQUEST["find12"]].$sortB[$_REQUEST["find13"]]."】";
									  } 
									  ?>
                                    </div>
                                </div>                                
...
<table id="simple-table" class="table table-bordered table-hover table-responsive">
    <thead>
        <tr>
            ...
            <th>
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=admin_num&find13=".(@$_REQUEST["find12"]=="admin_num" && @$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">代理<?php if (@$_REQUEST["find12"] == "admin_num" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a></th>
            <th>
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=u_id&find13=".(@$_REQUEST["find12"]=="u_id" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">帳號<?php if (@$_REQUEST["find12"] == "u_id" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php }?></a></th>
            <th class="hidden-480">
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=u_name&find13=".(@$_REQUEST["find12"]=="u_name" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">姓名<?php if (@$_REQUEST["find12"] == "u_name" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a></th>
            <th>
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=AllSave&find13=".(@$_REQUEST["find12"]=="AllSave" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">儲值<?php if (@$_REQUEST["find12"] == "AllSave" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a>
            /
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=AllSell&find13=".(@$_REQUEST["find12"]=="AllSell" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">拋售<?php if (@$_REQUEST["find12"] == "AllSell" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a></th>
            <th class="hidden-480">
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=WeekSell&find13=".(@$_REQUEST["find12"]=="WeekSell" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">周拋售次數<a href="#" data-toggle="tooltip" title="每周一 00點起"><?php if (@$_REQUEST["find12"] == "WeekSell" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?><i class="glyphicon glyphicon-question-sign"></i></a></th>            
            <th class="hidden-480">
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=login_time&find13=".(@$_REQUEST["find12"]=="login_time" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">登入<?php if (@$_REQUEST["find12"] == "login_time" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a>/
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=reg_time&find13=".(@$_REQUEST["find12"]=="reg_time" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">註冊時間<?php if (@$_REQUEST["find12"] == "reg_time" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a></th>
            <th class="hidden-480">
            <a href="<?php echo site_url(SYSTEM_URL."/Member/index?".$att2."&find12=login_ip&find13=".(@$_REQUEST["find12"]=="login_ip" &&@$_REQUEST["find13"]=="desc"?"asc":"desc") ) ?>">登入IP<?php if (@$_REQUEST["find12"] == "login_ip" ){?><?php if(@$_REQUEST["find13"]=="desc"){?>▼<?php }else{ ?>▲<?php } ?><?php } ?></a></th>
            <th>狀態</th>
            <th>管理</th>
        </tr>
    </thead>
    <tbody>
        ...
        ?>
        <tr class="<?php if ($row["is_vaid"] == '1') echo 'border_bottom' ?>">
            <td>
            ...
            <td>
                ...
                <div class="hidden-md hidden-lg text-danger">
                    <?php echo $row["u_name"]?>
                    <?php if($row["promoter"]):?>
                    <div class="red">(推廣：<?php echo $row["promoter"]?>)</div>
                    <?php endif;?>
                </div>
            </td>
            <td class="hidden-480">
            ...
            <td>
                ...
                ?>
                <div class="<?php echo $saveClass?>" data-rel="tooltip" title="儲值"><?php echo number_format($AllSave,0) ?></div>
                <div class="<?php echo $sellClass?>" data-rel="tooltip" title="拋售"><?php echo number_format($row["AllSell"],0) ?></div> 
            </td>
