	...
	$(function(){
	   ...
	   jQuery.validator.addMethod("checkUrl", function( value, element ) {
		  ...
		  if(value!=''){
			  $.ajax({
				  type: "POST",
				  url: CI_URL + "<?php echo SYSTEM_URL?>/Agents/ajax_chk_url",
				  cache: false,
				  async:false,
				  data: { cust_url : str,num:$('#cust_url').attr('data-num')}
			  }).done(function( msg ) { 	
				 if(msg.trim()=='Y'){
					 result=true;
				 }else{
                ...
                <div class="widget-body">
                    <div class="widget-main padding-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                            	<textarea name="cust_url" rows="3" data-num="<?php if(isset($row)) echo $row["num"]?>" class="form-control" id="cust_url" placeholder="代理網址"><?php if(isset($row)) echo $row["cust_url"]?></textarea>
                                <p class="form-control-static">輸入格式：abc.em66.net多筆請用","隔開</p>
                            </div>
                        </div>
