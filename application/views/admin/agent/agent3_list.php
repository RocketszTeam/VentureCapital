                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                      ...
                                      <?php if (@$_REQUEST["find1"]!=""){$find_msg.=($find_msg!="" ? "、" : "")."上層帳號=【".tb_sql("u_id","admin",@$_REQUEST["find1"])."】";} ?>
                                    </div>
                                 </div>
                                <?php endif;?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">代理網址</label>
                                    <div class="col-xs-12 col-sm-5">
                                      <input type="text" class="form-control" id="find5" name="find5" value="<?php echo @$_REQUEST["find5"]?>" placeholder="代理網址" />
                                      <?php if (@$_REQUEST["find5"]!=""){$find_msg.=($find_msg!="" ? "、" : "")."代理網址=【".@$_REQUEST["find5"]."】";} ?>
                                    </div>
                                </div>  
                                <div class="form-group">
...
<table id="simple-table" class="table table-bordered table-hover table-responsive">
    ...
    <tbody>
        ...
        <tr>
        	<td>
            	<?php echo tb_sql("u_id","admin",$row["root"])?>
                <br>
                (<?php echo tb_sql("u_name","admin",$row["root"])?>) 
            </td>
            <td>
				<?php echo tb_sql2("power_name","admin_group","u_power",$row["u_power"])?>
                <span class="badge badge-warning" data-rel="tooltip" title="(下線<?php echo show_member($row["num"])?>人)"><?php echo show_member($row["num"])?></span>
            </td>
            <td>
				<?php echo $row["u_id"]?>
