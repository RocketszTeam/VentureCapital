...
<script type="text/JavaScript">
    $(function(){
		$('#toDay').click(function(){	//本日
			$('#find7').val($(this).attr('data-d1') + ' 12:00:00');
			$('#find8').val($(this).attr('data-d2') + ' 12:00:00');
		});
		...
		$('#auto_report').click(function(){
			...
			$.ajax({
				type: "POST",
				url: CI_URL + "report/Maya_report/auto_report",
				cache: false,
				dataType:"json",
...
<div class="row">
	<form  method="get" action="">
        ...
        <div class="col-xs-12 col-sm-5">
            <div class="form-group">
                <div class="btn-group">
                	<button type="submit" class="btn btn-white btn-sm btn-primary">搜尋</button>
                    <button type="submit" class="btn btn-white btn-sm btn-primary" id="toDay" data-d1="<?php echo date('Y-m-d')?>" data-d2="<?php echo date('Y-m-d',strtotime("+1 day"))?>">本日</button>
                    <button type="submit" class="btn btn-white btn-sm btn-primary" id="yeDay" data-d1="<?php echo date('Y-m-d',strtotime("-1 day"))?>" data-d2="<?php echo date('Y-m-d',strtotime("+0 day"))?>">昨日</button>
                    ...
                    <button type="submit" class="btn btn-white btn-sm btn-primary" id="toMonth" data-d1="<?php echo date("Y-m-d",strtotime($toMonth['d1']." -1 day"))?>" data-d2="<?php echo $toMonth['d2']?>">本月</button>
                    <button type="sbumit" class="btn btn-white btn-sm btn-primary" id="ymMonth" data-d1="<?php echo date("Y-m-d",strtotime($ymMonth['d1']." -1 day"))?>" data-d2="<?php echo $ymMonth['d2']?>">上月</button>
