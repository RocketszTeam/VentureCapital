<script type="text/JavaScript">
    $(function(){
        ...
        $('#auto_report').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: CI_URL + "report/Slottery_report/auto_report",
                cache: false,
                dataType:"json",
        ...
        <div class="col-xs-12 col-sm-5">
            <div class="form-group">
                <div class="btn-group">
                    ...
                    <button type="submit" class="btn btn-white btn-sm btn-primary" id="yeDay" data-d1="<?php echo date('Y-m-d',strtotime("-1 day"))?>" data-d2="<?php echo date('Y-m-d')?>">昨日</button>
...
<!--            <td class="text-center">
                <span class="blue"><?php echo  number_format($row["Rake"],2,'.',',')?></span>
            </td>
-->            <td class="text-center">
                <span class="blue"><?php echo  number_format(@$row["Profit"],2,'.',',')?></span>
            </td>
...
<!--        <td class="text-center">
        ...
        <span class="blue"><?php echo  number_format($RakeTotal,2,'.',',')?></span>
        </td>
-->        <td class="text-center">
        <span class="blue"><?php echo  number_format(@$ProfitTotal,2,'.',',')?></span>
        </td>
