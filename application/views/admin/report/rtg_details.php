    ...
    <tbody>
        ...
        if(isset($result)):
            ...
            foreach($result as $row):
				...
				$validAmountTotal+=$row["bet"];
				$winOrLossTotal+=$row["winOrLose"];
        ?>
        <tr>
        	<td class="text-center">
                <div class="purple"><?php echo $row["gameStartDate"]?></div>
            ...
            <td class="text-center">
				<?php
                    ...
                    }elseif($row["winOrLose"] > 0){
                        $spanClass='text-success';
                    }
                ?>
                <span class="<?php echo $spanClass?>"><?php echo  number_format($row["winOrLose"],2,'.',',')?></span>
            </td>
        </tr>
        <?php endforeach;
		endif;
