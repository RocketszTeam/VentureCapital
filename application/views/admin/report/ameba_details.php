    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <div class="red"><?php echo $gameType[$row["TypeCode"]]?></div>
            </td>
            <td class="text-left">
				<?php if($row["Result"]=='W') echo '<span class="text-success">[贏]</span>'?>
                <?php if($row["Result"]=='L') echo '<span class="text-danger">[輸]</span>'?>
                <?php if($row["Result"]=='X') echo '<span class="text-danger">[未結算]</span>'?>
                <?php if($row["Result"]=='C') echo '<span class="text-danger">[註銷]</span>'?>
            </td>
