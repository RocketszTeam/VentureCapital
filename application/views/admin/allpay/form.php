                ...
                <div class="widget-body">
                    <div class="widget-main padding-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                            	<input type="text" class="form-control" id="MerchantID" name="MerchantID" value="<?php if(isset($row)) echo $row["MerchantID"]?>" placeholder="商店編號" required />
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">HashKey</label>
                            <div class="col-xs-12 col-sm-5">
                            	<input type="text" class="form-control" id="HashKey" name="HashKey" value="<?php if(isset($row)) echo $row["HashKey"]?>" placeholder="HashKey" required />
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="inputWarning" class="col-xs-12 col-sm-3 control-label no-padding-right">HashIV</label>
                            <div class="col-xs-12 col-sm-5">
                            	<input type="text" class="form-control" id="HashIV" name="HashIV" value="<?php if(isset($row)) echo $row["HashIV"]?>" placeholder="HashIV" required />
                            </div>
                        </div> 
                        <?php if($todo!='add'):?>
                        <div class="form-group">
