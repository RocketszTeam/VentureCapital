    ...
    <div role="tabpanel" class="tab-pane active" id="home"><br>
            ...
            <table class="table table-striped table-bordered bootstrap-datatable responsive" width="100%">
                ...
                <tbody>
					...
					?>
                    <tr>
                    	<td><?php echo tb_sql("kind","member_talk_kind",$row["kind"])?></td>
                        ...
                        <td><a href="<?php echo site_url(SYSTEM_URL."/Message/edit/".$row["num"])?>"  title="回覆"><?php echo $row["subject"]?></a></td>
                        <td><div class="text-<?php echo ($row['re_word']!="" ? 'success' : 'danger')?>">
						<?php echo ($row['re_word']!="" ? '是' : '否')?>
                        </div>
                        </td>
                        ...
                        <td >
							...
							?>
                        <?php if($row['re_word']=='' && $row["no_sound"]==0):?>
                        <div><button class="btn btn-danger" id="soundBTN" onClick="toCloseSound('member_talk','num','<?php echo $row["num"]?>')">靜音</button></div>
                        <?php endif;?>
                        </td>
