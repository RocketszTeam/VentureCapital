...
function CheckAuthentication()
{
	...
	return (!empty($_COOKIE["login_root"])?true:false);
}
...
*/
if(isset($_SESSION["ckfinderUrl"])){
	$baseUrl = $_SESSION["ckfinderUrl"];	
}else{
	$baseUrl = '/upload/';
}
/*
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl .'_Thumbnails' ,
		'directory' => $baseDir .'_Thumbnails' ,
		'enabled' => true,
		'directAccess' => true,
		'maxWidth' => 100,
		'maxHeight' => 100,
